...
public class frmBuddyList {
    ...
    public static void display(){
        ...
        rbFollowers.focusedProperty().addListener(event -> getFollowers());
        ...
        rbFollowing.focusedProperty().addListener(event -> getFollowing());
    ...
    public static void addBuddyComponents(User user){
        ...
        centerPane.getChildren().addAll(btnViewProfile, btnFollowUnfollow, divider);
    }
}
